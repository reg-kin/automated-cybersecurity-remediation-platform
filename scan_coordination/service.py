...
def _get_policy_for_execution(
    ...
    *,
    ...
    return {
        ...
        "service_tier": row[4],
        "profile_name": row[5],
        "scanner_parameters": row[6],
        "schedule_type": row[7],
        "schedule_expression": row[8],
        "schedule_timezone": row[9],
        "next_run_at": row[10],
        "is_enabled": row[11],
        "asset_lifecycle_status": row[12],
    }
...
def lease_next_execution(
    ...
    *,
    ...
    return {
        ...
        "scanner_type": row[4],
        "service_tier": row[5],
        "execution_node_id": row[6],
        "node_code": node["node_code"],
        "execution_model": row[7],
        "scanner_subject_type": row[8],
        "scanner_subject_value": row[9],
        "scanner_parameters": row[10],
        "status": row[11],
